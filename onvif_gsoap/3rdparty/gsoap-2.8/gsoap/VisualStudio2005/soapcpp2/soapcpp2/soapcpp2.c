...
int Qflag = 0;          /* when set, use C++ namespaces for custom statements */
...
-Qname  use name as the C++ namespace for decls, including custom statements\n\
-qname  use name as the C++ namespace for decls, excluding custom statements\n\
